...
echo 'deb http://ppa.launchpad.net/banshee-team/ppa/ubuntu intrepid main' | sudo tee -a /etc/apt/sources.list.d/launchpad.list
...
echo 'deb http://ppa.launchpad.net/gnome-colors-packagers/ppa/ubuntu intrepid main' | sudo tee -a /etc/apt/sources.list.d/launchpad.list
...
echo 'deb http://ppa.launchpad.net/bisigi/ppa/ubuntu intrepid main' | sudo tee -a /etc/apt/sources.list.d/launchpad.list
...
echo 'deb http://ppa.launchpad.net/ubuntu-wine/ppa/ubuntu intrepid main' | sudo tee -a /etc/apt/sources.list.d/launchpad.list
