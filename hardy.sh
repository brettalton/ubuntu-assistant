...
echo 'deb http://ppa.launchpad.net/banshee-team/ppa/ubuntu hardy main' | gksu tee -a /etc/apt/sources.list.d/launchpad.list
...
echo 'deb http://ppa.launchpad.net/gnome-colors-packagers/ppa/ubuntu hardy main' | gksu tee -a /etc/apt/sources.list.d/launchpad.list
...
echo 'deb http://ppa.launchpad.net/ubuntu-wine/ppa/ubuntu hardy main' | gksu tee -a /etc/apt/sources.list.d/launchpad.list
